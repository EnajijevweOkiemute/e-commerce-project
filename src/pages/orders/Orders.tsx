...
export function Orders() {
  ...
  // Merge API orders with local orders; API takes precedence by id
  const apiIds = new Set(apiOrders.map((o) => o.id));
  const localOnly = orders.filter(
    (o) => o.userId === currentUser?.id && !apiIds.has(o.id)
  );
  ...
  const mergedOrders = [
    ...apiOrders.map((o) => ({
      ...
      customer: { name: "", email: "", address: o.shippingAddress, city: "", country: "" },
    })),
    ...localOnly.map((o) => ({
      id: o.id,
      createdAt: o.createdAt,
    ...
    <section className="orders-section">
      <div className="orders-container">
        ...
        {!currentUser ? (
          ...
          <div className="orders-empty">
            <span className="orders-loading-spinner" />
